...
class SampleData {
    ...
    private func insertSampleData() {
        ...
        Friend.sampleData[0].favoriteMovie = Movie.sampleData[2]
        Friend.sampleData[0].favoriteMovie = Movie.sampleData[3]
        Friend.sampleData[0].favoriteMovie = Movie.sampleData[4]
